...
export function AboutHero() {
  return (
    <PageHero
      ...
      subtitle="VD Globals was founded on a simple belief: authority should be earned through credibility, expertise, and long-term reputation, not manufactured through marketing."
